...
public class FileScanner {
	...
	public static class BadNodeException extends Exception {
		...
		public BadNodeException(String reason) {
			super(reason);
		}
	}
	...
	public static class BadEdgeException extends Exception {
		...
		public BadEdgeException(String reason) {
			super(reason);
		}
	}
	...
	private static void readHeader(int[] cnt, BufferedReader reader, StringPosition pos, Logger logger,
			boolean isTolerant) throws BadHeaderException, IOException {
	...
	private static FmiNode readNode(BufferedReader reader, StringPosition pos, Node[] nodes, Logger logger,
			boolean isTolerant) throws BadNodeException, IOException {
	...
	private static FmiEdge readEdge(BufferedReader reader, StringPosition pos, Node[] nodes, Logger logger,
			boolean isTolerant) throws BadEdgeException, IOException {
	...
	public static Node[] readStructure(BufferedReader reader, Logger logger, boolean isTolerant)
		...
		logger.info("Header of file parsed successfully" + System.lineSeparator() + "  " + cnt[0] + " nodes"
				+ System.lineSeparator() + "  " + cnt[1] + " edges" + System.lineSeparator() + System.lineSeparator()
		...
		logger.info("maxLat: "+ maxLat + " minLat: " + minLat + " maxLong: "+ maxLong + " minLong: " + minLong);
	...
	public static int readTarget(BufferedReader reader, StringPosition pos, int maxId, Logger logger,
			boolean isTolerant) throws BadRequestException, IOException {
	...
	public static int[] readRequest(BufferedReader reader, StringPosition pos, int maxId, Logger logger,
			boolean isTolerant) throws BadRequestException, IOException {
